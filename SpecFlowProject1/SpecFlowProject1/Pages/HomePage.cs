...
namespace SpecFlowProject1.PageObjects
{
    class HomePage
    {
        ...
        public void NaviHomePage(IWebDriver driver)
        {
            this.driver = driver;
            ...
            IWebElement MouseHover = driver.FindElement(By.XPath("/html/body/div/div/div/div[1]/div[2]/div/span"));
            ...
            IWebElement GoToProfile = driver.FindElement(By.XPath("//*[@id='service-search-section']/div[1]/div[2]/div/span/div/a[1]"));
            GoToProfile.Click();
        }
        ...
        public void CertificationsPage(IWebDriver driver)
        {
